...
def format_message(p, is_vip=False):
    ...
    return (
           ...
           "{}\n"
        "----------------\n"
        "\U0001f464 <b>ID:</b> <code>{player_id}</code>\n"
        "\U0001f4b0 <b>Win amount:</b> <b>{win_amount}</b>\n"
        "\U0001f3e6 <b>Balance:</b> {total_balance}\n"
        "----------------\n"
        "\U0001f4ca <b>Player stats:</b>\n"
        "  \U0001f4b3 Last deposit: {last_deposit}\n"
        "  \U0001f522 Deposit count: {total_deposit_count}\n"
        "  \U0001f4b5 Total deposits: {total_deposit_amount}\n"
        "  \U0001f504 Withdrawal count: {total_withdrawal_count}\n"
        "  \U0001f4e4 Total withdrawals: {total_withdrawal_amount}\n"
        "  \U0001f4c8 Net deposit: {net_deposit_amount}\n"
        "----------------\n"
        "{}"
    ).format(
        title,
